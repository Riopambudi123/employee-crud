...
class EmployeeControllers extends Controller
{
    ...
    public function update(Request $request, Employee $employee)
    {
        ...
        return redirect()->route('employee.index')->with('succes','Data Karyawan Berhasil di Update');
    }
    ...
    public function destroy(Employee $employee)
    {
        ...
        return redirect()->route('employee.index')->with('succes','Data Karyawan Berhasil di Hapus');
    }
}